...
需要围绕{% label red, 用户痛点 %}、{% label blue, 差异化功能 %}和{% label green, 轻量化体验 %}展开
...
{% gallery url,https://example.com/mockup-gallery.json %}
